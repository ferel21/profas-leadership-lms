...
| R-003 | Upload materi/tugas | File berbahaya, path traversal, kehilangan file ephemeral, atau public exposure | 3 | 4 | 12 | Private filesystem volume pada VPS; private Supabase Storage wajib pada Vercel; magic-byte validation; path/ownership authorization; signed URL berumur pendek | Antivirus scanning, lifecycle/retention policy, backup/restore object, migrasi legacy public files | Platform Lead | Open |
