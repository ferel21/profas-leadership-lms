...
const settingsSchema = z.object({
  name: z.string().trim().min(2, "Nama lengkap minimal 2 karakter.").max(80, "Nama lengkap maksimal 80 karakter."),
  ...
  headline: z.string().trim().max(100, "Jabatan maksimal 100 karakter."),
  bio: z.string().trim().max(300, "Bio maksimal 300 karakter."),
  organization: z.string().trim().max(100, "Nama organisasi maksimal 100 karakter."),
  location: z.string().trim().max(100, "Lokasi maksimal 100 karakter."),
