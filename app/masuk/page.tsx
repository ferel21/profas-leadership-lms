    ...
    <main className="auth-page">
      ...
      <section className="auth-panel">
        ...
        <div className="auth-card">
          ...
          <h1>Lanjutkan perjalanan<br/><em>kepemimpinan Anda.</em></h1>
          <p>Masuk untuk mengakses program dan progres belajar.</p>
          <AuthForm mode="login" redirectTo={redirectTo} errorParam={error} reasonParam={reason} />
